 ...
 * @author Hp
 */
public class oneEmpDetails extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Text greetings = new Text("Show Employee Details");
        ...
        if(s1==null)
        {
         Text t1 = new Text("No Employee has this ID");
