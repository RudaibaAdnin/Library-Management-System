 ...
 * @author JOHN
 */
//public class show_last_date_of_submission {
...
public class show_last_date_of_submission extends Application{
...
int i = 0;
    ...
    public void start(Stage primaryStage) {
        ...
        grid2.setStyle("-fx-background-color:	navajowhite;");
        grid2.setHgap(30);
        grid2.setVgap(20);
       ...
       Button back = new Button("Back");
        ...
        a.setOnAction(new EventHandler<ActionEvent>() {
            ...
            Connection con = new OracleDBMS().getConnection();
             ...
             String sql1="SELECT MEMBER_ID FROM STORE_MEM";
            ...
            PreparedStatement pst1 = con.prepareStatement(sql1);
                    ...
                    ResultSet rs1 = pst1.executeQuery();
                     ...
                     while(rs1.next()) {
                      ...
                      String sql="SELECT ISSUE_ID,BOOK_ID,MEMBER_ID,ISSUE_DATE,LAST_DATE_OF_SUBMISSION\n" +
"FROM ISSUES where ISSUE_ID=" 
        ...
        catch(Exception e)
        {
         ...
         Text greetings1 = new Text("Last Date of Submission  : " + ID[0]);
        ...
        if(s1==null)
        {
         Text t1 = new Text("No issue Available");
