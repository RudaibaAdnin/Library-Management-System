 ...
 * @author Hp
 */
public class chngPassEmp extends Application {
        ...
        a.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                ...
                if (go_for_more) {
                 ...
                 String sql="SELECT * FROM LOGIN_EMPLOYEE where EMPLOYEE_ID = "
                    + ""+ID[0]+"";
            ...
            final Stage dialog = new Stage();
               ...
               T1.setFont(Font.font(" Corsiva", FontWeight.LIGHT,16));
                ...
                if(s3.equals(name[0]))
                {
                 ...
                 {
                     g=1;
                     String sql="UPDATE LOGIN_EMPLOYEE\n" +
"SET PASSWORD_EMPLOYEE = "
                    + ""+wh[0]+""+"WHERE EMPLOYEE_ID="+""+ID[0]+"" ;
        ...
        grid2.add(r1, 1, 3);
         ...
         Button f= new Button("Back");
        f.setPrefSize(100,40);
       
        f.setStyle("-fx-background-color:skyblue; -fx-text-fill: black;");
     
        f.setAlignment(Pos.CENTER_LEFT);
        
        VBox om = new VBox(50);
        om.getChildren().add(f);
