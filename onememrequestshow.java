...
public class onememrequestshow extends Application{
 ...
 TableColumn<req,Integer> bookidcol=new TableColumn<>("REQUEST_ID");
        ...
        TableColumn<req,Integer> booknamecol=new TableColumn<>("BOOK_ID");
        ...
        TableColumn<req,String> catidcol=new TableColumn<>("Member_ID");
          ...
          catidcol.setCellValueFactory(new PropertyValueFactory<>("Cat_id"));
                  ...
                  TableColumn<req,String> amntcol=new TableColumn<>("DEPARTMENT");
    ...
    public ObservableList<req> getmem(){
       ...
       float total = 0;
        ...
        String sqlprice = 
                 ...
                 "SELECT BOOK_ID,BOOK_NAME,MEMBER_ID,REQUEST_DATE\n" +
                     "FROM BOOK_REQUEST\n" 
                +
                    "WHERE MEMBER_ID="+st1+"";
