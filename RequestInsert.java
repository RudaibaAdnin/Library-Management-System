...
public class RequestInsert extends Application{
        int i = 0;
    ...
    public void start(Stage primaryStage) {
        ...
        Text greetings = new Text("Add New Book Request");
      ...
      /*    Text qhead2 = new Text("MEMBER ID");
        ...
        Text qhead5 = new Text("Request Date");
        ...
        grid.add(backemp,1,11);
         ...
         back.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                ...
                Button back1 = new Button("RequestTable");
        ...
        grid.add(backemp1,1,10);
         ...
         back1.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                ...
                onememrequestshow b2=new onememrequestshow();
                try {
                    b2.start(stage);
                } catch (Exception ex) {
                    Logger.getLogger(BookLend.class.getName()).log(Level.SEVERE, null, ex);
        ...
        a.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                if (go_for_more) {
                 ...
                 /*String sql="INSERT INTO BOOK_REQUEST(REQUEST_ID,BOOK_ID,BOOK_NAME,MEMBER_ID,REQUEST_Date)"
                    + " VALUES ("+ID[0]+","+name[0]+",'"+DB[0]+"',"+wh[0]+",TO_DATE('"+ot[0]+"', 'DD/MM/YYYY'))";*/
            ...
            PreparedStatement pst1 = con.prepareStatement(sql1);
                    ...
                    ResultSet rs1 = pst1.executeQuery();
                     ...
                     String sql="INSERT INTO BOOK_REQUEST(BOOK_ID,BOOK_NAME,MEMBER_ID,REQUEST_Date)"
                    + " VALUES ("+ID[0]+",'"+name[0]+"',"+st1+",SYSDATE)";
