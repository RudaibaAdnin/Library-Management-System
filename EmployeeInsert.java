...
//import databaseprojectsample.OracleDBMS;
...
public class EmployeeInsert extends Application{
        int i = 0;
    ...
    public void start(Stage primaryStage) {
        ...
        Text qhead1 = new Text("Employee Name");
        ...
        pr1[0] = new VBox();
          ...
          Text qhead2 = new Text("Designation");
        ...
        pr2[0] = new VBox();
            ...
            Text qhead4 = new Text("Working hour");
        ...
        pr4[0] = new VBox();
           ...
           Text qhead5 = new Text("Max Over Time");
        ...
        pr7[0] = new VBox();
            ...
            pr7[0].getChildren().add(p7[0]);
                           ...
                           Text qhead8 = new Text(" Date of Birth");
        ...
        grid.add(backemp1,0,9);
         ...
         back1.setOnAction(new EventHandler<ActionEvent>() {
          ...
          Button back3 = new Button("Employee Education Insert");
        VBox backemp3= new VBox(50);
        back3.setPrefSize(200, 40);
        backemp3.setAlignment(Pos.CENTER);
        backemp3.getChildren().add(back3);
        grid.add(backemp3,2,9);
         ...
         back3.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                ...
                empeduInsert bl=new empeduInsert();
                try {
                    bl.start(stage);
                } catch (Exception ex) {
                    Logger.getLogger(BookLend.class.getName()).log(Level.SEVERE, null, ex);
        ...
        a.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                if (go_for_more) {
                    ...
                    String sql="INSERT INTO Employee (Employee_ID,Employee_Name,Designation,working_Hour,Over_time,Salary,Joining_DAte,Date_of_birth)"
                    + " VALUES ("+ID[0]+",'"+name[0]+"','"+DB[0]+"',"+wh[0]+","+ot[0]+","+sl[0]+",TO_DATE('"+bhik[0]+"','DD/MM/YYYY'),TO_DATE('"+jd[0]+"','DD/MM/YYYY'))";
            System.out.println(sql);
           String sql1="Insert INTO OVER_TIME(EMPLOYEE_ID,SALARY,OVERTIME,NEW_SALARY)"
                   +"VALUES("+ID[0]+","+sl[0]+",'0',"+sl[0]+")";
              try{
            Connection con = new OracleDBMS().getConnection();
            PreparedStatement pst = con.prepareStatement(sql);
