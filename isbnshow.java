...
public class isbnshow extends Application{

    String id;
    TableView<isbn> table;
    Stage stage;
...
//To change body of generated methods, choose Tools | Templates.
 ...
 TableColumn<isbn,Integer> bookidcol=new TableColumn<>("BOOK_ISBN_NO");
        ...
        TableColumn<isbn,Integer> booknamecol=new TableColumn<>("BOOK_ID");
      ...
      /*  TableColumn<book,Integer> catidcol=new TableColumn<>("CATAGORY_ID");
          ...
          table.getColumns().addAll(bookidcol,booknamecol);
          VBox vbox=new VBox();
    ...
    public ObservableList<isbn> getbook(){
        ObservableList<isbn> bb=FXCollections.observableArrayList();
           ...
           try{
            ...
            PreparedStatement pst = con.prepareStatement(sqlprice);
                ...
                while (rs.next()){
                    ...
                    bb.add(new isbn(rs.getInt(1),rs.getString(2)));
