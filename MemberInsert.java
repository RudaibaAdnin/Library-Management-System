...
public class MemberInsert extends Application{
        int i = 0;
    ...
    public void start(Stage primaryStage) {
     ...
     /*   Text qhead1 = new Text("Student ID");
        ...
        Button back1 = new Button("Member Requests show");
        VBox backemp1= new VBox(50);
        back1.setPrefSize(200,40);
        backemp1.setAlignment(Pos.CENTER);
        backemp1.getChildren().add(back1);
        grid.add(backemp1,1,6);
        ...
        a.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                ...
                /* String sql="INSERT INTO Members(Member_ID,Student_ID,Member_Name,Department,Joining_Date,Date_of_birth,FINE_AMOUNT)"
                    + " VALUES ('"+ID[0]+"','"+name[0]+"','"+DB[0]+"','"+wh[0]+"','"+ot[0]+"','"+sl[0]+"',"+jd[0]+")";
            System.out.println(sql);*/
           String sql1="DELETE FROM MEMBERS_REQUEST WHERE STUDENT_ID="
                   +""+ID[0]+"";
          ...
          /*  PreparedStatement pst = con.prepareStatement(sql);
           ...
           CallableStatement stmt=con.prepareCall("{call MEMBERID_UPDATE(?)}");
//                    //stmt.setInt(1,12); 
