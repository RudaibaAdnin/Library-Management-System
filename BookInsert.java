 ...
 * @author JOHN
 */
public class BookInsert extends Application{
        int i = 0;
    ...
    public void start(Stage primaryStage) {
        ...
        Text qhead1 = new Text("Book Name");
        ...
        pr1[0] = new VBox();
          ...
          Text qhead2 = new Text("Calegory ID");
        ...
        pr2[0] = new VBox();
            ...
            Text qhead4 = new Text("Book Isbn No");
        ...
        pr4[0] = new VBox();
         ...
         /* Text qhead5 = new Text("Book Isbn No");
        qhead5.setFill(Color.PURPLE);
        ...
        a.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                if (go_for_more) {
                    ...
                    String sql1="SELECT BOOK_ID FROM BOOKS WHERE BOOK_ID="
                            + ""+ID[0]+"";
                    ...
                    String sql="INSERT INTO BOOKS (BOOK_ID,BOOK_Name,Catagory_ID,Number_OF_COPIES)"
                    + " VALUES ('"+ID[0]+"','"+name[0]+"','"+DB[0]+"','1')";
                    
                     String sql4="INSERT INTO BOOK_ISBN(BOOK_ISBN_NO,BOOK_ID)"
                    + " VALUES ("+wh[0]+","+ID[0]+")"  ;
            System.out.println(sql);
                   ...
                   ResultSet rs1 = pst1.executeQuery();
                    ...
                    PreparedStatement pst4 = con.prepareStatement(sql4);
                     ...
                     while (rs1.next()) {
                         ...
                         System.out.println("value string"  + s1);
                     }
                     if(s1!=null)
                         
                    {
                        /*String sql2="UPDATE BOOKS SET NUMBER_OF_COPIES=NUMBER_OF_COPIES+"
                                +""+wh[0]+""+ "WHERE BOOK_ID="
                                +""+ID[0]+"";*/
                        
                         String sql2="UPDATE BOOKS SET NUMBER_OF_COPIES=NUMBER_OF_COPIES+1"
                                + "WHERE BOOK_ID="
                                +""+ID[0]+"";
