 ...
 * @author Hp
 */
public class overtimeupdate extends Application {
    ...
    public void start(Stage primaryStage) {
           ...
           String ID[]=new String[1];
              ...
              /*     ID[0]=p[0].getText();
                   ...
                   */
                     ...
                     a.setStyle("-fx-background-color:skyblue; -fx-text-fill: black;");
        ...
        f1.setStyle("-fx-background-color:cyan; -fx-text-fill: black;");
        ...
        grid.add(om1,1,11);
         ...
         Button f2= new Button("OvertimeTable");
        f2.setPrefSize(100,40);
       
        f2.setStyle("-fx-background-color:orchid; -fx-text-fill: black;");
     
        f2.setAlignment(Pos.CENTER_LEFT);
        
        VBox om2 = new VBox(50);
        om2.getChildren().add(f2);
        om2.setAlignment(Pos.CENTER);
...
"SET OVERTIME =OVERTIME+"
            ...
            PreparedStatement pst = con.prepareStatement(sql1);
             ...
             CallableStatement stmt=con.prepareCall("{call OVERTIME_SAL_UPDATE(?)}");
//                    //stmt.setInt(1,12); 
