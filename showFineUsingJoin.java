...
public class showFineUsingJoin extends Application{
...
int i = 0;
    ...
    public void start(Stage primaryStage) {
        ...
        grid2.setStyle("-fx-background-color:snow;");
        grid2.setHgap(30);
        grid2.setVgap(20);
        ...
        Text greetings = new Text("Show Fine ");
        ...
        a.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                if (go_for_more) {
                 ...
                 String sql="SELECT M.MEMBER_ID,M.STUDENT_ID,M.MEMBER_NAME,F.AMOUNT_OF_FINE\n" +
"FROM MEMBERS M JOIN FINES F\n" +
...
"WHERE M.MEMBER_ID= "
        ...
        catch(Exception e)
        {
         ...
         Text greetings1 = new Text("Amount of Fine of a Member Having Member ID : " + ID[0]);
        ...
        if(s1==null)
        {
         Text t1 = new Text("No Fine For This Member");
