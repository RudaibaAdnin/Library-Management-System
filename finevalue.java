 ...
 * @author Hp
 */
public class finevalue extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        grid.setStyle("-fx-background-color:blanchedalmond ;");
        grid.setHgap(30);
        grid.setVgap(20);
        ...
        a.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                if (go_for_more) {
                 ...
                 String sql="SELECT STUDENT_ID,MEMBER_ID,COUNT_FINE(MEMBER_ID) FROM MEMBERS";
                 
                 //SELECT MEMBER_ID,COUNT_FINE(MEMBER_ID) FROM MEMBERS;
